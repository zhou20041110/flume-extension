...
public class ORCFileWriterMain {
	...
	public static void main(String[] args) throws IOException {
		...
		struct.setFieldValue(0, "1");
		struct.setFieldValue(1, "2");
		struct.setFieldValue(2, "3");

		OrcStruct struct2 = new OrcStruct(columns);

		struct2.setFieldValue(0, "4");
		struct2.setFieldValue(1, "5");
		struct2.setFieldValue(2, "6");

		OrcStruct struct3 = new OrcStruct(columns);

		struct3.setFieldValue(0, "7");
		struct3.setFieldValue(1, "8");
		struct3.setFieldValue(2, "9");
